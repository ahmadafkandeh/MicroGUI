...
extern void LCD_SetPointColor  (unsigned short color);
...
extern unsigned short GetDevCode(void);
void LCD_DrawCharTransparent (unsigned int x, unsigned int y, unsigned short *c); 
extern void LCD_PutString(u8 x,u16 y,const char *p);
extern void LCD_PutStringInBox(u8 x,u16 y,char *p,unsigned int Start,unsigned int Len);
#ifdef __cplusplus
}
#endif
#endif
